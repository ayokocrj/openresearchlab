  ...
  return (
    <div className="bg-transparent text-white selection:bg-white/20">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black/20 text-white perspective-1000">
        ...
        <div className="relative z-10 max-w-[1400px] w-full mx-auto px-6 md:px-12 pt-24 md:pt-40 pb-20 flex flex-col justify-center min-h-[95vh] pointer-events-none text-center">
          <div className="max-w-7xl mx-auto pointer-events-auto">
            ...
            <p className="font-serif italic text-white/50 text-xl md:text-3xl mb-8 md:mb-12 tracking-wide leading-relaxed">Bridging the AI Frontier for the 99%.</p>
            <h1 className="font-bold text-4xl md:text-8xl lg:text-[7.5rem] leading-[0.9] tracking-tighter text-white mb-12 md:mb-16 uppercase mix-blend-exclusion antialiased text-silver drop-shadow-2xl py-4">
              Where vision finds <br className="hidden md:block" />
              capital. And capital <br className="hidden md:block" />
              finds purpose.
            </h1>
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-16 mt-8 md:mt-16">
              <p className="text-gray-400 text-lg md:text-2xl max-w-xl leading-tight font-light tracking-tight">
              ...
              <div className="flex flex-col md:flex-row gap-4 md:gap-8 w-full md:w-auto">
                <button className="bg-white text-black px-8 py-5 md:px-14 md:py-7 rounded-full font-black hover:bg-neutral-200 transition-all flex items-center justify-center group uppercase tracking-[0.2em] text-[10px] md:text-xs shadow-[0_20px_60px_rgba(255,255,255,0.1)]">
                  View the Experiment <ArrowRight className="ml-4 group-hover:translate-x-2 transition-transform" size={20} />
                </button>
                <button className="border border-white/20 text-white px-8 py-5 md:px-14 md:py-7 rounded-full font-black hover:bg-white/10 transition-all uppercase tracking-[0.2em] text-[10px] md:text-xs backdrop-blur-md">
      ...
      <section className="py-24 md:py-48 bg-black/40 backdrop-blur-md border-y border-white/5 relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row gap-16 md:gap-32">
            <div className="w-full lg:w-1/3">
              <span className="mono text-[10px] text-indigo-400 uppercase tracking-[0.6em] font-black block mb-6 md:mb-10">The_Experimentation_Platform</span>
              <h2 className="font-serif italic text-4xl md:text-5xl lg:text-7xl text-white/90 leading-[1.0] tracking-tight">A Living Laboratory for the Future of Work.</h2>
      ...
      <section className="py-24 md:py-48 bg-[#030303] relative overflow-hidden group">
        ...
        <div className="max-w-[85rem] mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            <div className="lg:col-span-5 space-y-12 md:space-y-16 pt-0 md:pt-12">
              <div>
                ...
                <h3 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter uppercase leading-[0.9] md:leading-[0.85] text-white pr-0 md:pr-12 drop-shadow-[0_0_30px_rgba(255,255,255,0.1)]">
                  The Anti-Google <br />
      ...
      <section className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-black border-y border-white/5">
        <div className="bg-[#f0f0f0] text-black p-8 md:p-24 flex flex-col justify-center">
          ...
          <p className="text-2xl md:text-3xl text-black/60 leading-snug font-light mb-16 md:mb-24 max-w-xl tracking-tighter">
        ...
        <div className="bg-black text-white p-8 md:p-24 flex flex-col justify-center relative overflow-hidden border-l border-white/10">
          ...
          <h3 className="text-4xl md:text-6xl font-bold tracking-tighter uppercase mb-6 md:mb-10 leading-[0.9] md:leading-[0.8] text-silver italic pr-0 md:pr-24">The <br />Agentic <br />Operator.</h3>
          <p className="text-2xl md:text-3xl text-white/70 leading-snug font-light mb-16 md:mb-24 max-w-xl tracking-tighter">
